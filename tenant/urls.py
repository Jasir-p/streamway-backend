...
from tenant.views import TenantView, RegisterTenant, SendOTPView, LoginView, CheckAuthView, MyTokenRefreshView,resend_otp_view,logout_user,CompanydetailView
